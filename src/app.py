...
with tab4:
    ...
    if st.button("Generar Predicción Maestra"):
        p1 = engines.engine_lstm_engineer()
        p2 = engines.engine_statistician()
        p3 = engines.engine_game_theory()
        
        st.write("🤖 **IA:**", str(p1))
        st.write("📊 **Estadística:**", str(p2))
        st.write("♟️ **Estrategia:**", str(p3))
